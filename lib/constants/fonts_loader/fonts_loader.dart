...
class FontsLoader {
  ...
  Future<void> loadFonts() async {
    //LORA
    _pdffonts.add(
      pw.Font.ttf(await rootBundle.load("assets/fonts/lora/Lora-Regular.ttf")),
    );
    _pdffonts.add(
      pw.Font.ttf(await rootBundle.load("assets/fonts/lora/Lora-Bold.ttf")),
    );
    _pdffonts.add(
      pw.Font.ttf(await rootBundle.load("assets/fonts/lora/Lora-Italic.ttf")),
    );
    _pdffonts.add(
      pw.Font.ttf(
    ...
    _pdffonts.add(
      pw.Font.ttf(
        await rootBundle.load(
          "assets/fonts/Courier/CourierPrime-BoldItalic.ttf",
        ),
      ),
    );
    _pdffonts.add(
    ...
    _pdffonts.add(
      pw.Font.ttf(
        await rootBundle.load("assets/fonts/philosopher/philosopher-Bold.ttf"),
      ),
    );
    _pdffonts.add(
      pw.Font.ttf(
        await rootBundle.load(
          "assets/fonts/philosopher/philosopher-Italic.ttf",
        ),
      ),
    );
    _pdffonts.add(
      pw.Font.ttf(
        await rootBundle.load(
          "assets/fonts/philosopher/philosopher-BoldItalic.ttf",
        ),
      ),
    );
    _pdffonts.add(
      pw.Font.ttf(await rootBundle.load("assets/fonts/lobster/lobsterTwo.ttf")),
    );
    _pdffonts.add(
      pw.Font.ttf(
    ...
    _pdffonts.add(
      pw.Font.ttf(
        await rootBundle.load("assets/fonts/lobster/lobsterTwo-BoldItalic.ttf"),
      ),
    );
    _pdffonts.add(
      pw.Font.ttf(
    ...
    _pdffonts.add(
      pw.Font.ttf(await rootBundle.load("assets/fonts/Tinos/Tinos-Bold.ttf")),
    );
    _pdffonts.add(
      pw.Font.ttf(await rootBundle.load("assets/fonts/Tinos/Tinos-Italic.ttf")),
    );
    _pdffonts.add(
      pw.Font.ttf(
    ...
    _pdffonts.add(
      pw.Font.ttf(
        await rootBundle.load(
          "assets/fonts/Inria_Serif/InriaSerif-Regular.ttf",
        ),
      ),
    );
    _pdffonts.add(
    ...
    _pdffonts.add(
      pw.Font.ttf(
        await rootBundle.load("assets/fonts/Inria_Serif/InriaSerif-Italic.ttf"),
      ),
    );
    _pdffonts.add(
      pw.Font.ttf(
        await rootBundle.load(
          "assets/fonts/Inria_Serif/InriaSerif-BoldItalic.ttf",
        ),
      ),
    );
    _pdffonts.add(
      pw.Font.ttf(await rootBundle.load("assets/fonts/Lato/Lato-Regular.ttf")),
    );
    _pdffonts.add(
      pw.Font.ttf(await rootBundle.load("assets/fonts/Lato/Lato-Bold.ttf")),
    );
    _pdffonts.add(
      pw.Font.ttf(await rootBundle.load("assets/fonts/Lato/Lato-Italic.ttf")),
    );
    _pdffonts.add(
      pw.Font.ttf(
    ...
    _pdffonts.add(
      pw.Font.ttf(
        await rootBundle.load("assets/fonts/Ubuntu_Mono/UbuntuMono-Italic.ttf"),
      ),
    );
    _pdffonts.add(
      pw.Font.ttf(
